...
<div class="container">
    ...
    <div class="content">
        <table class="user-table">
            ...
            <tbody>
            <c:forEach items="${reportLists}" var="reportList">
                <tr>
                    <td><c:out value="${reportList.logIndex}" /></td>
                    <td><c:out value="${reportList.userId}" /></td>
                    <td><c:out value="${reportList.clientIp}" /></td>
                    <td><c:out value="${reportList.reportType}" /></td>
                    <td><c:out value="${reportList.studyKey}" /></td>
                    <td><c:out value="${reportList.reportIndex}" /></td>
                    <td><c:out value="${reportList.reportDate}" /></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
